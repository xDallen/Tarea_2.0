              ...
              {isAuthenticated ? (
                <>
                  <div className="flex items-center space-x-4 mr-4">
                    ...
                    >
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.523 5.754 19 7.5 19s3.332-.477 4.5-1.253m0-13C13.168 5.477 14.754 5 16.5 5s3.332.477 4.5 1.253v13C19.832 18.523 18.246 19 16.5 19s-3.332-.477-4.5-1.253" />
                      </svg>
                      Posts
                    </Link>
                  </div>
            ...
            <div className="md:hidden py-4 border-t border-gray-200 bg-white/95 backdrop-blur-md">
              {isAuthenticated ? (
                <div className="space-y-2">
                  ...
                  <Link
                    to="/posts"
                    className={mobileNavLinkClasses('/posts')}
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <div className="flex items-center">
                      <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
